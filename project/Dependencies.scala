...
object Dependencies {
  ...
  lazy val munit = Def.setting("org.scalameta" %%% "munit" % "0.7.19")
  lazy val munitScalacheck = Def.setting("org.scalameta" %%% "munit-scalacheck" % "0.7.19")
  ...
  lazy val jawnAst = "org.typelevel" %% "jawn-ast" % "1.0.0"
